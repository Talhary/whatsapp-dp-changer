...
const { state, saveCreds } = await useMultiFileAuthState('Talha')
...
const color = (text, color) => {
  return !color ? chalk.green(text) : chalk.green(text) ;
};
...
async function startHisoka() {
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    try {
      ...
      // console.log(m.quoted? m.quoted.mtype== 'imageMessage'? m.quoted.url: 'false ' :'false'  )
     if(m.quoted){
       console.log(await client.readMessages(m.sender))
